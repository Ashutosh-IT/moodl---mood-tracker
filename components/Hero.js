...
export default function Hero() {
  return (
    <div className='py-4 md:py-10 flex flex-col gap-8 sm:gap-10'>
      ...
      <h1 className={"text-5xl sm:text-text-6xl md:text-7xl text-center " + fugaz.className}><span className='textGradient'>Moodl</span> helps you track you <span className='textGradient'>daily</span> mood!</h1>
